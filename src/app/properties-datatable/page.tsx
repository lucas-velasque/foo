...
import PropertiesDataTable from '../../components/datatable/PropertiesDataTable';

const PropertiesDataTablePage: React.FC = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="flex space-x-4">
              ...
              <button
                onClick={() => router.push('/properties-datatable')}
...
export default PropertiesDataTablePage;
